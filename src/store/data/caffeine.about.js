const caffeineAbout = {
  ...
  'description': [
    `The objective for this project was to redesign Caffeine’s about page and sign up flow.
    The goals were to emphasize core product features (e.g. chat and player experience for viewers and broadcasters),
    underscore available platforms (e.g. web and iOS), spotlight partnered broadcasters, and create a friendly
    design language. Both items were designed in tandem for a cohesive product experience. The About Page took the
