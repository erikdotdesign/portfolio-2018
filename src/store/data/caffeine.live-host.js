const caffeineLiveHost = {
  ...
  'description': [
    ...
    It offers simple and easy to use tools for broadcasters to live stream using their browser, mobile device,
    or Windows gaming machine. The Live Host feature is built atop Caffeine’s web and iOS applications.
  ...
  'images': [{
    ...
    'url': require('../../routes/WorkDetail/assets/img/lh-g-8.png'),
    'retina': require('../../routes/WorkDetail/assets/img/lh-g-8@2x.png'),
